...
using std::set, std::string, std::vector, std::unordered_set;

inline unordered_set<string> MOCK_EMPTY_RESULT = {};
...
inline unordered_set<string> MOCK_RESULTS_1_COL = {"a", "b", "c", "d", "e"};

inline unordered_set<string> MOCK_RESULTS_2_COL = {
    "a a", "a b", "a c", "a d", "a e", "b a", "b b", "b c", "b d",
    "b e", "c a", "c b", "c c", "c d", "c e", "d a", "d b", "d c",
    "d d", "d e", "e a", "e b", "e c", "e d", "e e"};

inline unordered_set<string> MOCK_RESULTS_2_COL_2 = {
...
inline unordered_set<string> MOCK_ALL_COL = {
