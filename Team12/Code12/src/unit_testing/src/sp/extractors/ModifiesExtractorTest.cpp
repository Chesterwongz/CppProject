...
TEST_CASE("ModifiesExtractor - if node") {
  ...
  ifNode->addChild(make_unique<LtNode>(make_unique<VarNode>("num1"),
                                       make_unique<VarNode>("num2")));
...
TEST_CASE("ModifiesExtractor - if in while node") {
  ...
  whileNode->addChild(make_unique<LtNode>(make_unique<VarNode>("x"),
  ...
  ifNode->addChild(make_unique<EqNode>(make_unique<VarNode>("x"),
                                       make_unique<VarNode>("y")));
  unique_ptr<StmtListNode> thenStmtListNode = make_unique<StmtListNode>();
