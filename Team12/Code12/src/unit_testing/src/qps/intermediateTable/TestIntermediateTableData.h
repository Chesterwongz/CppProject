...
string COL_NAME_5 = "column 5";
string COL_NAME_6 = "column 6";

vector<string> DOUBLE_COL_NAME_VECTOR = {COL_NAME_1, COL_NAME_2};
...
vector<vector<string>> DOUBLE_COL_VECTOR_DATA_CROSS = {
        {  "0",  "1",  "banana",  "cat",  },
        {  "0",  "1",  "lettuce",  "pineapple",  },
        {  "0",  "1",  "pear",  "dog",  },
        {  "0",  "1",  "meow",  "woof",  },
        {  "0",  "1",  "carrot",  "durian",  },
        {  "0",  "1",  "tomato",  "cucumber",  },
...
vector<string> MULTI_COL_NAME_VECTOR_1 = {COL_NAME_4, COL_NAME_3, COL_NAME_2, COL_NAME_1};
vector<vector<string>> MULTI_COL_DATA_1 = {
        { "0", "1", "banana", "cat" },
        { "2", "3", "lettuce", "pineapple" },
        { "4", "5", "pear", "dog" },
        { "6", "7", "meow", "woof" },
...
vector<string> MULTI_COL_NAME_VECTOR_2 = {COL_NAME_5, COL_NAME_6, COL_NAME_2, COL_NAME_1};
vector<vector<string>> MULTI_COL_DATA_2 = {
        { "0", "1", "banana", "cat" },
        { "2", "3", "lettuce", "lettuce" },
...
vector<vector<string>> MULTI_COL_DATA_JOIN = {
        { "0", "1", "0", "1", "banana", "cat", },
        { "6", "5", "banana", "cat", "carrot", "durian", },
        { "2", "1", "4", "3", "hamster", "mouse", },
};
