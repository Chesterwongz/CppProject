...
inline vector<string> MULTI_COL_NAME_VECTOR_1 = {COL_NAME_4, COL_NAME_3, COL_NAME_2, COL_NAME_1};
inline vector<string> MULTI_COL_NAME_VECTOR_WITH_WILDCARD = {COL_NAME_4, COL_NAME_3, COL_NAME_WILDCARD, COL_NAME_1};
...
inline vector<string> MULTI_COL_NAME_VECTOR_2 = {COL_NAME_5, COL_NAME_6, COL_NAME_2, COL_NAME_1};
...
inline vector<vector<string>> COL_3_2D = {
        {"banana"},
        {"lettuce"},
        {"pear"},
        {"meow"},
