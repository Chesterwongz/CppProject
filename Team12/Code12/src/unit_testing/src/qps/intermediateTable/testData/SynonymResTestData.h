...
inline TableDataType MOCK_PRINT_SYNONYM_RES_VECTOR_2D = {{MOCK_PRINT_SYN_1},
                                                         {MOCK_PRINT_SYN_2},
                                                         {MOCK_PRINT_SYN_3},
                                                         {MOCK_PRINT_SYN_4}};
...
inline TableDataType DOUBLE_COL_SYNONYM_RES_DATA = {
...
inline TableDataType DOUBLE_COL_SYNONYM_RES_DATA_2 = {
...
inline TableDataType DOUBLE_COL_SYNONYM_RES_DATA_3 = {
...
inline TableDataType MULTI_COL_SYNONYM_RES_DATA_1 = {
...
inline vector<string> SYNONYM_RES_MULTI_COL_NAME_2 = {"constant", "proc", "var",
                                                      "print"};
inline TableDataType MULTI_COL_SYNONYM_RES_DATA_2 = {
...
inline TableDataType DOUBLE_COL_SYNONYM_RES_DATA_CROSS = {
...
inline TableDataType MULTI_COL_SYNONYM_RES_DATA_INNER_JOIN = {
