...
TEST_CASE("test_PatternClause_isEqual") {
	...
	PatternClause patternClause1 = PatternClause(std::move(patternSynonymPtr1), std::move(patternArgsStreamTest1), false);
	...
	PatternClause patternClause2 = PatternClause(std::move(patternSynonymPtr2), std::move(patternArgsStreamTest2), false);
...
TEST_CASE("test_PatternClause_evaluate_synonymFirstArg") {
	...
	PatternClause patternClause = PatternClause(std::move(patternSynonymPtr), std::move(patternArgsStreamTest), false);
