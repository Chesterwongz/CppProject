...
inline vector<string> MOCK_PARENT_STARS({"pc stars 1", "pc stars 3",
                                         "pc stars 5", "pc stars 7"});

inline vector<string> MOCK_CHILD_STARS({"pc stars 2", "pc stars 4",
                                        "pc stars 6", "pc stars 8"});
