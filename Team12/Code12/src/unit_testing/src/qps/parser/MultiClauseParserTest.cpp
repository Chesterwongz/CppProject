...
TEST_CASE("Valid pattern a and if") {
  ...
  // pattern a1 ("x", _)
  unique_ptr<SynonymArg> outerSyn1 = std::make_unique<SynonymArg>(ass1);
  ...
  // pattern a2 ("x", _"x"_)
  unique_ptr<SynonymArg> outerSyn2 = std::make_unique<SynonymArg>(ass2);
  ...
  // Follows (a1, a2)
  unique_ptr<SynonymArg> firstArg3 = std::make_unique<SynonymArg>(ass1);
  unique_ptr<SynonymArg> secondArg3 = std::make_unique<SynonymArg>(ass2);
  ...
  // Parent* (w1, a2)
  unique_ptr<SynonymArg> firstArg4 = std::make_unique<SynonymArg>(while2);
  unique_ptr<SynonymArg> secondArg4 = std::make_unique<SynonymArg>(ass2);
  ...
  // Parent* (w1, w2)
  unique_ptr<SynonymArg> firstArg5 = std::make_unique<SynonymArg>(while1);
  unique_ptr<SynonymArg> secondArg5 = std::make_unique<SynonymArg>(while2);
