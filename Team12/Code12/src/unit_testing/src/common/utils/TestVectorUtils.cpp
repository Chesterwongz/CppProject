...
vector<string> vector1 = { "0", "1", "banana", "cat", "2", "3", "lettuce", "pineapple" };
...
vector<string> VECTOR_1_CONCAT_2 = { "0", "1", "banana", "cat", "2", "3", "lettuce", "pineapple",
                                     "4", "5", "pear", "dog", "6", "7", "meow", "woof" };
vector<string> VECTOR_1_CONCAT_3 = { "0", "1", "banana", "cat", "2", "3", "lettuce", "pineapple",
                                     "0", "1", "potato"};
