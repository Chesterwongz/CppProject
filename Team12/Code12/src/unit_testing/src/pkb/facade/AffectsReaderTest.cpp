...
//     REQUIRE(
//         compareVectorContents(affectsReader.getAffectedBy(6,
//         StmtType::ASSIGN),
//                               std::vector<std::string> {"2", "6"}));
//     REQUIRE(
//         compareVectorContents(affectsReader.getAffectedBy(1,
//         StmtType::ASSIGN),
//                               std::vector<std::string> {}));
...
//     REQUIRE(
//         compareVectorContents(affectsReader.getAffectedBy(5,
//         StmtType::ASSIGN),
...
//         affectsReader.getAffectsPairs();
//     REQUIRE(compareVectorContents(
//         result, std::vector<std::pair<std::string, std::string>> {{"1",
//         "3"}}));
//     REQUIRE(compareVectorContents(affectsReader.getAffects(1,
//     StmtType::ASSIGN),
//                                   std::vector<std::string> {"3"}));
//     REQUIRE(
//         compareVectorContents(affectsReader.getAffectedBy(3,
//         StmtType::ASSIGN),
//                               std::vector<std::string> {"1"}));
//     REQUIRE(
//         compareVectorContents(affectsReader.getAffectedBy(4,
//         StmtType::ASSIGN),
//                               std::vector<std::string> {}));
...
//     REQUIRE(
//         compareVectorContents(affectsReader.getAffectedBy(11,
//         StmtType::ASSIGN),
...
TEST_CASE("AffectsReader Tests 7 - Autotester") {
  ...
  SECTION("AffectsPairs") {
    ...
    std::vector<std::pair<std::string, std::string>> expectedResults = {
        ...
        {"11", "17"}, {"11", "19"}, {"12", "7"},  {"12", "12"}, {"13", "16"},
        {"15", "17"}, {"16", "17"}, {"17", "18"}, {"17", "19"}, {"18", "19"},
        {"21", "22"}};
