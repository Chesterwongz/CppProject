...
//     QPS qps(pkb.getReader());
//     auto result = qps.processQueryString(query);
//     unordered_set<string> expected = {"i", "x", "y", "z"};
//     REQUIRE(result == expected);
// }
...
//     QPS qps(pkb.getReader());
//     auto result = qps.processQueryString(query);
//     unordered_set<string> expected = {"Example", "p"};
//     REQUIRE(result == expected);
// }
//
// TEST_CASE("SP-PKB-QPS tests/Sample_queries.txt - 8") {
...
//     QPS qps(pkb.getReader());
//     auto result = qps.processQueryString(query);
//     unordered_set<string> expected = {"p", "q"};
//     REQUIRE(result == expected);
// }
//
// TEST_CASE("SP-PKB-QPS tests/Sample_queries.txt - 9") {
...
//     "9", "10", "11"}; REQUIRE(result == expected);
// }
//
// TEST_CASE("SP-PKB-QPS tests/Sample_queries.txt - 11") {
//     string query =
...
//     QPS qps(pkb.getReader());
//     auto result = qps.processQueryString(query);
//     unordered_set<string> expected = {"2", "3", "5", "7", "11"};
//     REQUIRE(result == expected);
// }
//
// TEST_CASE("SP-PKB-QPS tests/Sample_queries.txt - 12") {
...
//     QPS qps(pkb.getReader());
//     auto result = qps.processQueryString(query);
//     unordered_set<string> expected = {"9", "11"};
//     REQUIRE(result == expected);
// }
//
// TEST_CASE("SP-PKB-QPS tests/Sample_queries.txt - 13") {
...
//     string query =
//         "procedure p, q;\n"
//         "Select BOOLEAN such that Calls(p, q) with q.procName = \"p\" and
//         p.procName = \"Example\"";
//     SourceProcessor sp;
//     PKB pkb;
//     sp.processContent(sampleSource, pkb.getWriter());
...
//     QPS qps(pkb.getReader());
//     auto result = qps.processQueryString(query);
//     unordered_set<string> expected = {"17", "18", "19", "20"};
//     REQUIRE(result == expected);
// }
//
// TEST_CASE("SP-PKB-QPS tests/Sample_queries.txt - 22") {
...
//     QPS qps(pkb.getReader());
//     auto result = qps.processQueryString(query);
//     unordered_set<string> expected = {"Example p i", "Example p x", "Example
//     p y", "Example p z", "Example q i", "Example q x", "Example q y",
//     "Example q z", "p q i", "p q x", "p q z"}; REQUIRE(result == expected);
// }
//
// TEST_CASE("SP-PKB-QPS tests/Sample_queries.txt - 23") {
//     string query =
//         "call c; assign a1, a2;\n"
//         "Select BOOLEAN such that Follows*(_, c) and Affects(a1, a2) and
//         Uses(a2, _)";
//     SourceProcessor sp;
//     PKB pkb;
//     sp.processContent(sampleSource, pkb.getWriter());
...
//     string query =
//         "assign a1, a2; variable v;\n"
//         "Select v pattern a1(v, _) such that Affects*(a1, a2) and Uses(a2,
//         v)";
//     SourceProcessor sp;
//     PKB pkb;
//     sp.processContent(sampleSource, pkb.getWriter());
//     QPS qps(pkb.getReader());
//     auto result = qps.processQueryString(query);
//     unordered_set<string> expected = {"i", "x", "z"};
//     REQUIRE(result == expected);
// }
//
// TEST_CASE("SP-PKB-QPS tests/Sample_queries.txt - 25") {
...
//         "Select c such that Next*(n1, n2) and Modifies(n1, v) and Uses(n2, v)
//         and Modifies(c, v)";
//     SourceProcessor sp;
//     PKB pkb;
//     sp.processContent(sampleSource, pkb.getWriter());
//     QPS qps(pkb.getReader());
//     auto result = qps.processQueryString(query);
//     unordered_set<string> expected = {"10", "12", "16"};
//     REQUIRE(result == expected);
// }
