...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 1") {
    string query =
        "stmt Follows;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 3") {
    string query =
        "stmt Select;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 4") {
    string query =
        "stmt s, S;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 5") {
    string query =
        "print Parent;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 7") {
    string query =
        "procedure p;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 8") {
    string query =
        "assign a; while w;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 9") {
    string query =
        "stmt s;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 11") {
    string query =
        "assign Parent;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 12") {
    string query =
        "print pn;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 14") {
    string query =
        "if while; while w;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 15") {
    string query =
        "if if; while w;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 17") {
    string query =
        "if if1, if, if2;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 18") {
    string query =
        "if if; while w;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 19") {
    string query =
        "if if; while w;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 20") {
    string query =
        "while w; stmt s;\n"
...
TEST_CASE("SP-PKB-QPS tests/Milestone1/SingleClauseTests/ParentT_queries.txt - 21") {
    string query =
        "while w; stmt s;\n"
