...
void PKBStorage::setVariableModification(const std::string& variableName, const std::string& procName) {
...
void PKBStorage::setVariableUsage(const std::string& variableName, const std::string& procName) {
...
std::unordered_set<std::string> PKBStorage::getModifiedVariablesForProc(const std::string& procName) {
...
std::unordered_set<std::string> PKBStorage::getUsedVariablesForProc(const std::string& procName) {
...
const std::unordered_map<std::string, std::unordered_set<std::string>>& PKBStorage::getCallsMap() {
    return callsStorage.getCallsMap();
}

void PKBStorage::setCalls(const std::string& callerProc, const std::string& calleeProc) {
    callsStorage.setCalls(callerProc, calleeProc);
}

void PKBStorage::setCallsStar(const std::string& callerProc, const std::string& calleeProc) {
    callsStorage.setCallsStar(callerProc, calleeProc);
}

std::unordered_set<std::string> PKBStorage::getDirectProcsCalledBy(const std::string& callerProc) {
    return callsStorage.getDirectProcsCalledBy(callerProc);
}

std::unordered_set<std::string> PKBStorage::getAllProcsCalledBy(const std::string& callerProc) {
    return callsStorage.getAllProcsCalledBy(callerProc);
}
