...
std::set<std::string> PKBReader::getStatement(StmtType statementType) {
  ...
  std::set<int> temp =
      storage.getStatementNumbersFromStatementType(statementType);
  for (int stmt : temp) {
...
std::string PKBReader::getFollowing(int statementNumber,
                                    StmtType statementType) {
  int followingStatement = storage.getImmediateFollows(statementNumber);
  if (followingStatement != -1 &&
      storage.isStatementType(followingStatement, statementType)) {
...
std::string PKBReader::getFollowed(int statementNumber,
                                   StmtType statementType) {
  int followedStatement = storage.getImmediateFollowedBy(statementNumber);
  if (followedStatement != -1 &&
      storage.isStatementType(followedStatement, statementType)) {
...
std::vector<std::pair<std::string, std::string>> PKBReader::getFollowsPairs(
    StmtType statementType1, StmtType statementType2) {
  std::set<int> firstStatementList =
      storage.getStatementNumbersFromStatementType(statementType1);
  std::set<int> secondStatementList =
      storage.getStatementNumbersFromStatementType(statementType2);
...
std::vector<std::pair<std::string, std::string>> PKBReader::getFollowsStar(
...
std::vector<std::pair<std::string, std::string>> PKBReader::getFollowedStar(
    int statementNumber, StmtType statementType) {
...
std::vector<std::pair<std::string, std::string>> PKBReader::getFollowsStarPairs(
    StmtType statementType1, StmtType statementType2) {
  std::set<int> firstStatementList =
      storage.getStatementNumbersFromStatementType(statementType1);
  std::set<int> secondStatementList =
...
PKBReader::getImmediateChildrenOf(int statementNumber, StmtType statementType) {
  std::set<int> allImmediateChildren =
      storage.getImmediateChildren(statementNumber);
...
std::pair<std::string, std::string> PKBReader::getImmediateParentOf(
    int statementNumber, StmtType statementType) {
  ...
  if (immediateParent != -1 &&
      storage.isStatementType(immediateParent, statementType)) {
...
std::vector<std::pair<std::string, std::string>> PKBReader::getParentChildPairs(
    StmtType parentType, StmtType childType) {
  std::set<int> firstStatementList =
      storage.getStatementNumbersFromStatementType(parentType);
  std::set<int> secondStatementList =
      storage.getStatementNumbersFromStatementType(childType);
...
std::vector<std::pair<std::string, std::string>> PKBReader::getChildrenStarOf(
    int statementNumber, StmtType statementType) {
...
std::vector<std::pair<std::string, std::string>> PKBReader::getParentStarOf(
    int statementNumber, StmtType statementType) {
...
std::vector<std::pair<std::string, std::string>>
PKBReader::getParentChildStarPairs(StmtType parentType, StmtType childType) {
  std::set<int> firstStatementList =
      storage.getStatementNumbersFromStatementType(parentType);
  std::set<int> secondStatementList =
      storage.getStatementNumbersFromStatementType(childType);
...
std::vector<std::string> PKBReader::getStatementsModifying(
  ...
  for (int statement : allMatchingStatements) {
    std::set<std::string> variables =
        storage.getModifiedVariablesForStatement(statement);
...
std::vector<std::pair<std::string, std::string>>
PKBReader::getVariablesModifiedBy(int statementNumber, StmtType statementType) {
  std::vector<std::pair<std::string, std::string>> result;

  if (storage.isStatementType(statementNumber, statementType)) {
    std::set<std::string> variables =
        storage.getModifiedVariablesForStatement(statementNumber);
...
bool PKBReader::isVariableModifiedBy(const std::string& variableName,
...
std::vector<std::string> PKBReader::getStatementsUsing(
    const std::string& variableName, StmtType statementType) {
  std::vector<std::string> result;
  ...
  for (int statementNumber : statementNumbers) {
    std::set<std::string> usedVariables =
        storage.getUsedVariablesForStatement(statementNumber);
...
std::vector<std::pair<std::string, std::string>> PKBReader::getVariablesUsedBy(
    int statementNumber, StmtType statementType) {
  std::vector<std::pair<std::string, std::string>> result;
...
bool PKBReader::isVariableUsedBy(const std::string& variableName,
                                 const std::string& statementNumber) {
...
std::vector<std::pair<std::string, std::string>>
PKBReader::getAllModifiedVariables(StmtType statementType) {
  std::vector<std::pair<std::string, std::string>> result;
  ...
  for (const std::string& v : variables) {
    std::set<int> statementNumbers =
        storage.getStatementNumbersForModifiedVariable(v);
...
std::vector<std::pair<std::string, std::string>> PKBReader::getAllUsedVariables(
    StmtType statementType) {
  std::vector<std::pair<std::string, std::string>> result;
  std::set<std::string> variables = storage.getAllVariables();
  ...
  for (const std::string& v : variables) {
    std::set<int> statementNumbers =
        storage.getStatementNumbersForUsedVariable(v);
...
std::vector<std::string> PKBReader::getExactAssignPattern(
...
std::vector<std::string> PKBReader::getPartialAssignPattern(
    const std::string& variableName, const std::string& rpn, bool isSynonym) {
...
bool PKBReader::isCallingStar(const std::string& caller,
                              const std::string& callee) {
...
unordered_set<string> PKBReader::getUsedVariablesForProc(
    const string& procName) {
  return storage.getUsedVariablesForProc(procName);
}
