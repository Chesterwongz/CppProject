...
void CallsStorage::setCallsRelationship(const string& caller, const string& callee, int statementNumber) {
...
void CallsStorage::setCallsStarRelationship(const string& caller, const string& callee, int statementNumber) {
...
vector<std::pair<string, string>> CallsStorage::getCalls(const string& procedure) {
...
vector<std::pair<string, string>> CallsStorage::getCallsStar(const string& procedure) {
    vector<std::pair<string, string>> result;
...
vector<std::pair<string, string>> CallsStorage::getCalledBy(const string& procedure) {
    vector<std::pair<string, string>> result;
...
vector<std::pair<string, string>> CallsStorage::getCalledByStar(const string& procedure) {
    vector<std::pair<string, string>> result;
...
vector<std::pair<string, string>> CallsStorage::getCallingProcedures() {
    vector<std::pair<string, string>> result;
    for (const auto& entry : callsMap) {
        for (const auto& pair : entry.second) {
...
vector<std::pair<string, string>> CallsStorage::getCalledProcedures() {
    vector<std::pair<string, string>> result;
