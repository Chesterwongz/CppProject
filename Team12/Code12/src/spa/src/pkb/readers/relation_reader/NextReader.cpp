...
std::vector<std::pair<std::string, std::string>> NextReader::getNextPairs(
  ...
  std::vector<std::pair<std::string, std::string>> allNextPairs = cfgStorage.getNextPairs();
  std::vector<std::pair<std::string, std::string>> result;
  for (std::pair<std::string, std::string> nextPair : allNextPairs) {
    bool isFirstStmtRightType = stmtStorage.isStatementType(stoi(nextPair.first), firstStmtType);
    bool isSecondStmtRightType = stmtStorage.isStatementType(stoi(nextPair.second), secondStmtType);
