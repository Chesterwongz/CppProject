...
unordered_set<string> CallsReader::getCallerProcs(
...
unordered_set<string> CallsReader::getCalleeProcs(
    const std::string& procName) {
  return callsStorage.getCalleeProcs(procName);
}

unordered_set<string>
CallsReader::getCalleeProcsStar(const std::string& procName) {
  return callsStorage.getCalleeProcsStar(procName);
}

unordered_set<string>
CallsReader::getAllCallerProcs() {
  return callsStorage.getAllCallerProcs();
}

unordered_set<string>
CallsReader::getAllCalleeProcs() {
