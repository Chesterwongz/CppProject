...
class ICallsReader {
 public:
  ...
  virtual std::vector<std::string> getCallerProcs(
      const std::string& procName) = 0;
  virtual std::vector<std::string> getCallerProcsStar(
      const std::string& procName) = 0;
  virtual std::vector<std::string> getCalleeProcs(
      const std::string& procName) = 0;
  virtual std::vector<std::string> getCalleeProcsStar(
      const std::string& procName) = 0;
