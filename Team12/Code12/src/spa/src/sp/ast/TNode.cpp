...
TNode::TNode(TNodeType type, string value)
...
std::string TNode::getValue() const { return value; }

TNodeType TNode::getType() const { return type; }
...
bool operator==(const TNode& lhs, const TNode& rhs) { return lhs.isEqual(rhs); }

bool operator!=(const TNode& lhs, const TNode& rhs) { return !(lhs == rhs); }
