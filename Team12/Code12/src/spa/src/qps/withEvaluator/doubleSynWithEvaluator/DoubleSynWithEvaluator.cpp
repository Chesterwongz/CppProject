...
IntermediateTable DoubleSynWithEvaluator::evaluate() {
  ...
  vector<SynonymRes> firstPKBResult =
  ...
  vector<SynonymRes> secondPKBResult =
      withEvaluatorFuncMap[secondEntityType]();
  IntermediateTable secondResult = IntermediateTableFactory::buildSingleColTable(
      secondSynonymValue, secondPKBResult);
